...
$sql=mysqli_query($con,"update topupcard set cardStatus='$status' where id='$oid'");
...
$st2='Cancelled';
$st3='Item Return';
   $rt = mysqli_query($con,"SELECT * FROM topupcard WHERE id='$oid'");
     while($num=mysqli_fetch_array($rt))
     {
     $currrentSt=$num['cardStatus'];
   }
     if($st==$currrentSt)
     { ?>
    <tr height="50">
