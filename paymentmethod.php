                    ...
                    <div class="mx auto">
                     ...
                     <!-- <div class="row padding-0">
                      <div class="col-sm-12"><br>
                        ...
                        <button class="btn btn-info pull-right" id="confirm-credit" onclick="window.location.href='creditcardepi.php';">Confirm</button><br><br>
                      </div>
                  </div>
               </div>
              ...
              buttons: {
                  confirm: function () {
                    $.ajax({
                      ...
                      window.location.replace("series-modal.php");
                      console.log('success');
                      },
                      error: function(err) {
