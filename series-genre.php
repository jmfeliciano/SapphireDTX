...
<div class="container-fluid">
         <?php
        if ($main_genre == 1) {
            echo'<h6 class="my-content">'.$series['action_tv_shows'].'</h6>';
        }
        elseif ($main_genre == 2) {
            echo'<h6 class="my-content">'.$series['adventure_tv_shows'].'</h6>';
        }
        elseif ($main_genre == 3) {
            echo'<h6 class="my-content">'.$series['comedy_tv_shows'].'</h6>';
        }
        elseif ($main_genre == 4) {
            echo'<h6 class="my-content">'.$series['drama_tv_shows'].'</h6>';
        }
        elseif ($main_genre == 5) {
            echo'<h6 class="my-content">'.$series['horror_tv_shows'].'</h6>';
        }
        elseif ($main_genre == 6) {
            echo'<h6 class="my-content">'.$series['romantic_tv_shows'].'</h6>';
        }
        elseif ($main_genre == 7) {
            echo'<h6 class="my-content">'.$series['scifi_tv_shows'].'</h6>';
        }
        elseif ($main_genre == 8) {
            echo'<h6 class="my-content">'.$series['kids_tv'].'</h6>';
        }
            $dataid;
